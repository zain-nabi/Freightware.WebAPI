...
namespace Triton.Service.Data
{
    public class RoleGroupService
    {
        ...
        {
            return await RestApiHelper.GetAsync<bool>(new Uri(UrlHelper.Api.TritonSecurityCommonApi, $"{UrlHelper.Controller.RoleGroup}IsRoleNameExistsAsync?roleName={roleName}"));
        }
